...
//头部子选项
var wenda_head = require('./template/head.art');
//我的提问
var getWendaQuestion = require('./template/question.art');
//我的回答
var getWendaAnswer = require('./template/answer.art');
//我的消息
var getWendaMessage = require('./template/message.art');
...
var wenda = {
    ...
    headClick: function () {
        var _this = this;
        $("#wenda-head a[data-click-types]").on("click", function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            //等待加载标识对应数据
                            return [4 /*yield*/, _this.getMyWenda(a)
                                //数据加载完毕,移除线条动画
                            ];
                        case 1:
                            //等待加载标识对应数据
