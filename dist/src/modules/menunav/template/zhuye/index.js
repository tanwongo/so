...
var zhuye = {
    ...
    init: function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                _this = this;
                //充填头部
                $("div[data-box-types='menutabs']").html(_this.getHeadHtml());
                //加载头部点击事件
                this.headClick();
                return [2 /*return*/];
            });
    ...
    headClick: function () {
        var _this = this;
        $("a[data-cmenunav-id]").on("click", function () {
            return __awaiter(this, void 0, void 0, function () {
                var a;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _this_ = this;
                        return [4 /*yield*/, $("a[data-newscont-types='discuss']").on("click", function () {
                                return __awaiter(this, void 0, void 0, function () {
                                    var a;
                                    return __generator(this, function (_a) {
                                        a = $(this).attr("data-newscont-box");
                                        //加载对应的主题回复模板数据
                                        $("div[data-newscont-box=discuss-" + a + "]").html(discuss()).stop(true, false).animate({ height: "100%", opacity: 1 }, 200);
                                        return [2 /*return*/];
                                    });
                                });
                            })];
    ...
    userFeedBack: function () {
        //a标签类型为反馈点击事件
        $("a[data-newscont-types='feedback']").on("click", function (e) {
            e.stopPropagation();
            //获取当前反馈对应的顶级list索引
            var a = $(this).attr("data-newscont-box");
            //获取对应的div
            var b = $("div[data-newscont-box=feedbackbox-" + a + "]");
            //获取对应的提交按钮
            var c = $("a[data-newscont-types='feedbacksubmit']");
            //显示对应的div
            ...
            b.find(c).unbind("click").on("click", function (e) {
                ...
                if (b.find("li").hasClass("active")) {
                    ...
                    setTimeout(function () {
                        ...
                        setTimeout(function () {
                            loadanimate_1["default"].succAnimate(b, true, "subsuccess", "提交成功");
