...
//头部子选项
var guba_head = require('./template/head.art');
//我的帖子
var getGubaPosting = require('./template/posting.art');
//我的回复
var getGubaReply = require('./template/reply.art');
//回复我的
var getGubaReplyMe = require('./template/replyme.art');
//赞我的
var getGubaZan = require('./template/zan.art');
//提到我的
var getGubaInv = require('./template/inv.art');
//问董秘
var getWenDongMi = require("./template/wendongmi.art");
...
var guba = {
   ...
   */
    ...
    headClick: function () {
        var _this = this;
        $("#guba-head a[data-click-types]").on("click", function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            //等待加载标识对应数据
                            return [4 /*yield*/, _this.getMyGuba(a)
                                //数据加载完毕,移除线条动画
                            ];
                        case 1:
                            //等待加载标识对应数据
